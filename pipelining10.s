.data
Numbers:	
.byte 37, 	10, 	8, 		73, 	72, 	124, 	5, 		28, 	49, 	110, 	106, 	39, 	38, 	73, 	78, 	112
...
.byte 59, 	76, 	28, 	46, 	38, 	118, 	17, 	9, 		66, 	81, 	45, 	69, 	84, 	77, 	120, 	50	#up to here, sum = 5390, row 5
...
.byte 68, 	8, 		87, 	15, 	57, 	76, 	124, 	79, 	4, 		13, 	35, 	12,	 	40, 	79, 	68, 	120	#up to here, sum = 10316, row 10 
...
.byte 124, 	126, 	24, 	12, 	38, 	100, 	29, 	116, 	6, 		106, 	72, 	26, 	34, 	117, 	113, 	32	#up to here, sum = 14801, row 15
...
.byte 109, 	115, 	73, 	94, 	24, 	66, 	59, 	67, 	97, 	72, 	3, 		4		1, 		29, 	56, 	55
.byte 121, 	103, 	44, 	55, 	66, 	32, 	18, 	105, 	82, 	70, 	42, 	40, 	85, 	66, 	121, 	11 	#up to here, sum = 19444, row 20  
...
.byte 43, 	103, 	50, 	65, 	92, 	67, 	91, 	3, 		37, 	113, 	33, 	106, 	26, 	96, 	71, 	22 	#up to here, sum = 24460 , row 25
...
.byte 117, 	33, 	22, 	37, 	81, 	27, 	55, 	61, 	98, 	15, 	55, 	2, 		19, 	73, 	62, 	75 	#up to here, sum = 29085 , row 30 
.byte 100, 	112, 	102, 	113, 	107, 	97, 	11, 	28, 	58, 	55, 	41, 	25, 	121, 	9, 		44, 	86
.byte 105, 	95, 	99, 	124 					#FINALE: 30617, ROW 32
...
.text
		...
		daddi $t1, $zero, 50	#index of 2nd subarray of 10
		daddi $t2, $zero, 100	#index of 3rd subarray of 10
		daddi $t3, $zero, 150	#index of 4th subarray of 10
		daddi $t4, $zero, 200	#index of 5th subarray of 10
		daddi $t5, $zero, 250	#index of 6th subarray of 10
		daddi $t6, $zero, 300	#index of 7th subarray of 10
		daddi $t7, $zero, 350	#index of 8th subarray of 10
		daddi $t8, $zero, 400	#index of 9th subarray of 10
		daddi $t9, $zero, 450	#index of 10th subarray of 10

		lwu $a1, CONTROL($zero)	# preparing #
		lwu $a2, DATA($zero)	# for print #

loop:	lbu $s1, Numbers($t0)	#$t0 is index of 1st subarray
		daddi $t0, $t0, 1		#index++
		...
		daddi $s2 ,$zero, sum   #printing "Sum = "
		daddi $v0, $zero, 4
		sd $s2, ($a2)        
        sd $v0, ($a1)
